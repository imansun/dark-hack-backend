...
export class CreatePostDto {
  @ApiProperty({
    description: 'Post title (Persian)',
    maxLength: 200,
    example: 'معماری نرم‌افزار مدرن',
  })
  @IsString()
  @IsNotEmpty()
  @MaxLength(200)
  ...
  @ApiProperty({
    ...
    maxLength: 200,
    required: false,
    example: 'هندسة البرمجيات الحديثة',
  })
  @IsString()
  @IsOptional()
  @MaxLength(200)
  ...
  @ApiProperty({
    description: 'Post content (Persian)',
  ...
  @ApiProperty({
    ...
    required: false,
    example: 'AI, Security, Architecture',
  })
  @IsString()
  @IsOptional()
  tags?: string;
